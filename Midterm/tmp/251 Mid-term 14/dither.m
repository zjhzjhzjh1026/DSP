...
stem(n,en);
xlim([0 length(en)-1]);
xlabel('n');ylabel('Value');title(['N=256 point eror series e(n) b=' num2str(b) ' dithered2']);
%% 2
...
stem(0:m,e_auto); 
title(['The autocorrelation sequence estimate c_{ee}(m) of e(n) b=' num2str(b) ' dithered2']); 
...
title(['Power Spectrum Estimate of e(n) b=' num2str(b) ' dithered2']); 
